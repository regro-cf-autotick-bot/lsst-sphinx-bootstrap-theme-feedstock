About lsst-sphinx-bootstrap-theme
=================================
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8917&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lsst-sphinx-bootstrap-theme-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `lsst-sphinx-bootstrap-theme` can be installed with:

```
conda install lsst-sphinx-bootstrap-theme
```

It is possible to list all of the versions of `lsst-sphinx-bootstrap-theme` available on your platform with:
